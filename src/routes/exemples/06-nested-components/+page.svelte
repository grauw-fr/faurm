<script lang="ts">
    ...
    import {Control, Field, Label} from "$lib/components/index.js";
...
<form {...enhance} enctype="multipart/form-data">
    {#each fields.todos.value() as _,i}
        ...
        <br>
    {/each}
    <button type="button" onclick={() => fields.todos.set([...fields.todos.value(), {done: false, title: ""}])}>Add todo</button>
