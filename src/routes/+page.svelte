...
<ul>
    <li><del>Typesafe backend validation of forms, using [standard schemas](https://github.com/standard-schema/standard-schema)</del></li>
...
<p>Want to add a feature to the list ? Pop over to <a href="https://github.com/grauw-fr/faurm" target="_blank">github</a> and create an issue !</p>
